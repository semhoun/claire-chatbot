...
require dirname(__DIR__) . '/fixtures/sse/SseLoad.php';

$options = getopt('', ['clients:', 'seconds:', 'help']);
if (isset($options['help'])) {
    fwrite(STDOUT, "Usage: php test/Integration/sse-load.php [--clients=64] [--seconds=3]\n"
        . "Clients: 4..512; seconds per idle/active plateau: 1..30. Artifacts: /tmp/kilo/sse-load-*.\n"
        . "Starts console sse:serve, a Slim fixture on free port 8082, and disposable local Redis.\n"

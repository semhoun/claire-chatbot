...
(function() {
    ...
    (function() {
        ...
        [btnCancel, backdrop].forEach(function(el){ if (el) el.addEventListener('click', closeDialog); });
    ...
    (function () {
        ...
        function expand() {
            ...
            if (window.htmx) {
                window.htmx.ajax('GET', baseUrl + '/history/list', { target: '#historyList', swap: 'innerHTML', indicator: '#globalActionIndicator' });
            }
        }
        function collapse() { btn.setAttribute('aria-expanded', 'false'); try { panel.innerHTML = ''; } catch (e) {} }
        function toggle() { if (isExpanded()) { collapse(); } else { expand(); } }
        btn.addEventListener('click', toggle);
        btn.addEventListener('keydown', function (e) { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); toggle(); } });
    })();
    ...
    (function () {
        ...
        function expand() {
            btn.setAttribute('aria-expanded', 'true');
            if (window.htmx) {
                window.htmx.ajax('GET', baseUrl + '/files/list', { target: '#filesList', swap: 'innerHTML', indicator: '#globalActionIndicator' });
            }
        }
        function collapse() { btn.setAttribute('aria-expanded', 'false'); try { panel.innerHTML = ''; } catch (e) {} }
        function toggle() { if (isExpanded()) { collapse(); } else { expand(); } }
    ...
    (function () {
        ...
        function getChatBody() { return document.querySelector('.chat-body'); }
        ...
        function initChatEventSource(sessionId) {
            ...
            const chatId = document.querySelector('[data-current-chat-id-input]')?.value || '';
